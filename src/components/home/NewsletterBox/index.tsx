  ...
  return (
    <div className="w-full h-80 flex flex-col items-start justify-start">
      ...
      >
        ...
        <p className="text-theme-grayscale-darker text-start font-sans mb-4">
        ...
        <input
          className="w-full lg:w-1/3 rounded-md border bg-theme-white-base border-secondary-light px-4 py-2 mb-4 focus:outline-none focus:ring-2 focus:ring-secondary-base focus:border-transparent text-theme-grayscale-black placeholder:text-theme-grayscale-darkest placeholder:opacity-50"
          type="email"
