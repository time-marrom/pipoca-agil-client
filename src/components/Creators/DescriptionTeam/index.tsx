  ...
  return (
    <>
      <div className="bg-[#FCCF5C] w-full">
        <div className="w-full h-full flex flex-col items-center justify-center text-start py-12 2xl:px-80 xl:px-36 px-8 rounded-t-[90px] md:px-8 md:py-20 lg:px-32  bg-[#FCFCFC]">
