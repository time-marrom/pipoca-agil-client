        ...
        <div className="w-full flex flex-col items-center py-4 gap-12 md:gap-20 md:flex-row">
          <div className=" flex flex-col items-center  md:items-start gap-4 md:gap-8 md:w-2/3">
            <p className=" font-sans font-normal text-base mb-2 md:text-2xl  md:w-full">
              {/* {data.volunteerText} */}
              Se você está em transição de carreira para alguma das áreas acima
              e quer finalmente ter aquela experiência prática, o projeto de
              Simulação é para você.
            </p>
            <Link
          ...
          <div className="flex flex-col items-center md:items-start gap-4 md:gap-8 md:w-2/3">
            <p className="font-sans font-normal text-base  mb-2 md:text-2xl md:w-full ">
              {/* {data.mentorText} */}
              Caso você já tenha uma bagagem sólida em alguma dessas áreas, pode
              se juntar a nós para orientar e ajudar quem está dando seus
