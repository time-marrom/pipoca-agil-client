  ...
  return (
    <div className="w-full flex flex-row justify-center items-center text-center mx-auto mb-2 gap-1 md:gap-6">
      <div className="flex flex-col items-center justify-center text-center p-1">
        ...
        />
        <p className="font-medium text-sm md:text-lg font-title">Termo de Consentimento</p>
      </div>
      <div className="flex flex-col items-center justify-center text-center p-1">
        <AiOutlineUser
          data-current-step={currentStep}
        ...
        />
        <p className="font-medium text-sm md:text-lg font-title">Preenchimento de Dados</p>
      </div>
      <div className="flex flex-col items-center justify-center text-center p-1">
        <GiConfirmed
          data-current-step={currentStep}
        ...
        />
        <p className="font-medium text-sm md:text-lg font-title">Confirmação</p>
      </div>
    </div>
  );
}
