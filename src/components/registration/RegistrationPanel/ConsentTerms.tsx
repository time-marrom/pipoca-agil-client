          ...
          <AlertDialogDescription className="font-normal text-base font-sans overflow:scroll text-start text-theme-grayscale-black">
            ...
            <ol className="px-4">
              ...
              <li className="list-decimal">
                ...
                membros realocados ou  poderão ser desfeitas, entenderemos que
                os membros das mesmas não tem disponibilidade e daremos a
              ...
              <li className="list-decimal">
                ...
                colaborativos e estejam dispostos a compartilhar idéias, ouvir
