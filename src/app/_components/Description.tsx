...
export function Description({ content }: DescriptionProps) {
  ...
  return (
    <div className="bg-[#FCCF5C] w-full">
      <div className="w-full h-full flex flex-col items-center justify-center text-start px-4 md:px-8 py-12 md:py-10 gap-2 rounded-t-[90px] lg:px-32 lg:py-24 bg-[#FCFCFC]">
