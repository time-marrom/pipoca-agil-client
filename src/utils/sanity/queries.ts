export const queries: SanityQueries = {
  ...
  mentor:
    "/production?query=*%5B_type+%3D%3D+%22mentor%22%5D%5B0%5D+%7B%0A++rules%2C+%0A++buttonToOpenTerms%2C%0A++buttonToCancel%2C%0A++buttonToSubmit%2C%0A++acceptTheTerms%2C%0A++%22steps%22%3A+steps%5B%5D+%7Bstep%2C+description%7D%2C%0A++title%2C%0A++termsTitle%2C%0A++LGPDWarning%2C%0A++LGPDWarningTitle%2C%0A++titleOfRules%2C++%0A++terms%2C%0A++warning%2C%0A++warningTitle%0A%7D%0A%0A",
  voluntary:
    "/production?query=*%5B_type+%3D%3D+%22voluntary%22%5D%5B0%5D+%7B%0A++rules%2C+%0A++buttonToOpenTerms%2C%0A++buttonToCancel%2C%0A++buttonToSubmit%2C%0A++acceptTheTerms%2C%0A++%22steps%22%3A+steps%5B%5D+%7Bstep%2C+description%7D%2C%0A++title%2C%0A++termsTitle%2C%0A++LGPDWarning%2C%0A++LGPDWarningTitle%2C%0A++titleOfRules%2C++%0A++terms%2C%0A++warning%2C%0A++warningTitle%0A%7D%0A%0A",
};
